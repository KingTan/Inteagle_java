...
import com.inteagle.config.FileConfig;
...
public class FileService {
	...
	public Map<String, String> saveThumbnail(MultipartFile file, String pathType, Integer type) {
		...
		String path = AppConfig.basePath + FileConfig.getProperty(pathType);
		if (!file.isEmpty()) {
			try {
	...
	private String changeUrl(String savePath) {
		String result = savePath.replace(AppConfig.basePath, "");
		return AppConfig.baseUrl + result;
	}
