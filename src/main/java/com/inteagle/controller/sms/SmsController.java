package com.inteagle.controller.sms;
...
import com.inteagle.utils.RandomUtil;
import com.inteagle.utils.sms.SMS_util;
import com.inteagle.utils.sms.SendSMS;
...
public class SmsController {
	...
	public JsonResult<Object> sendSMSCode(String phoneNumber, String codeType) {
		...
		// 真实验证码开关
		if (!AppConfig.IdentifyingCodeFlag) {
			// 保存验证码到缓存中
